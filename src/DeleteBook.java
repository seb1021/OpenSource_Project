    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(LibrarianDao.validate(UserName.getText(),Pass))
        {
             ...
             if(TransBookDao.CheckIssuedBook(BookIDV))
                 JOptionPane.showMessageDialog(DeleteBook.this, "장난감이 대여중입니다","에러!", JOptionPane.ERROR_MESSAGE);     
             else
             {
                 if(BookDao.Delete(BookIDV)!=0)
             {
                 JOptionPane.showMessageDialog(DeleteBook.this, "장난감을 삭제하였습니다","삭제!", JOptionPane.ERROR_MESSAGE);
                 UserName.setText("");
                 password.setText("");
                 BookID.setText("");
             }
             else
                  JOptionPane.showMessageDialog(DeleteBook.this, "장난감을 삭제할 수 없습니다","에러!", JOptionPane.ERROR_MESSAGE); 
        }
        }
