    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(TransBookDao.BookValidate(BookID.getText()) && TransBookDao.UserValidate(UserID.getText()))
        {
               if(TransBookDao.CheckIssuedBook(BookIDV))
               {
                   ...
                   {
                        JOptionPane.showMessageDialog(ReturnBookForm.this, "장난감이 사용자에 의해 반납되었습니다!","장난감 반납 완료!", JOptionPane.ERROR_MESSAGE);
                        UserID.setText("");
                        BookID.setText("");
                   }
                   else
                        JOptionPane.showMessageDialog(ReturnBookForm.this, "장난감을 반납할 수 없습니다!","장난감 반납 실패!", JOptionPane.ERROR_MESSAGE);
                       
               }
               else
                JOptionPane.showMessageDialog(ReturnBookForm.this, "이 장난감은 빌릴 수 없습니다!","장난감 대여 실패!", JOptionPane.ERROR_MESSAGE);
        }
        else
        {    if(TransBookDao.UserValidate(UserID.getText()))
                    JOptionPane.showMessageDialog(ReturnBookForm.this, "이 장난감은 장난감 목록 정보에 없습니다!","장난감 반납 실패!", JOptionPane.ERROR_MESSAGE);
             else
                if(TransBookDao.BookValidate(BookID.getText()))
                    JOptionPane.showMessageDialog(ReturnBookForm.this, "이 사용자는 사용자 목록 정보에 없습니다!","장난감 반납 실패!", JOptionPane.ERROR_MESSAGE);
                 else
            JOptionPane.showMessageDialog(ReturnBookForm.this, "이 장난감과 사용자는 목록에 없습니다!","장난감 반납 실패!", JOptionPane.ERROR_MESSAGE);
