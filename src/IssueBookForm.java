    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(TransBookDao.BookValidate(BookID.getText()) && TransBookDao.UserValidate(UserID.getText()))
        {
            ...
            if(TransBookDao.Check(UserIDV)==0)
               JOptionPane.showMessageDialog(IssueBookForm.this, "사용자가 대여 개수를 초과하였습니다","대여 에러!", JOptionPane.ERROR_MESSAGE); 
           else
            {
            if(TransBookDao.IssueBook(BookIDV, UserIDV, IFDate, RFDate)!=0)
            {
              
                JOptionPane.showMessageDialog(IssueBookForm.this, "장난감이 대여되었습니다!","장난감 대여 완료!", JOptionPane.ERROR_MESSAGE);
                BookID.setText("");
                UserID.setText("");
            }
            else
              JOptionPane.showMessageDialog(IssueBookForm.this, "장난감을 대여 할 수 없습니다!","장난감 대여 에러!", JOptionPane.ERROR_MESSAGE);
            }
        ...
        {    if(TransBookDao.UserValidate(UserID.getText()))
                    JOptionPane.showMessageDialog(IssueBookForm.this, "이 장난감은 장난감 목록에 없습니다!","장난감 대여 에러!", JOptionPane.ERROR_MESSAGE);
             else
                if(TransBookDao.BookValidate(BookID.getText()))
                    JOptionPane.showMessageDialog(IssueBookForm.this, "이 사용자는 사용자 목록에 없습니다!","장난감 대여 에러!", JOptionPane.ERROR_MESSAGE);
                 else
            JOptionPane.showMessageDialog(IssueBookForm.this, "이 장난감과 사용자는 목록에 없습니다!","장난감 대여 에러!", JOptionPane.ERROR_MESSAGE);
