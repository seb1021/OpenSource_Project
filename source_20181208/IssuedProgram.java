...
import mainlibrary.TransToyDao;
import static mainlibrary.LibrarianSuccess.ThisLogined;
/**
 *
 * @author bikash
 */
public class IssuedProgram extends javax.swing.JFrame {

    /**
     * Creates new form IssueToyForm
     */
    public IssuedProgram() {
        initComponents();
        int year;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IssuedProgram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IssuedProgram().setVisible(true);
            }
        });
    }
