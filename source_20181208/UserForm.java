...
public class UserForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         System.out.println("성공성공1");
         if(UsersDao.CheckIfAlready(User))
         {
            System.out.println("성공성공2");
             JOptionPane.showMessageDialog(UserForm.this, "사용자 이름이 이미 있습니다!","사용자 추가 에러!", JOptionPane.ERROR_MESSAGE);
         }
         else
         {
            System.out.println("성공성공3");
        ...
        int IDNum = Integer.parseInt(Position.getText());   //사용자번호 
        String child =Program.getText();
        System.out.println("성공성공4");
        int childage = Integer.parseInt(Year.getText());
        String phone = Email.getText();   //휴대폰 번호
       // Date = RYear+"-"+RMonth+"-"+RDate;
        System.out.println("성공성공5");
                if(UsersDao.AddUser(User,IDNum,child,childage,phone)!=0)
                {
                    JOptionPane.showMessageDialog(UserForm.this, "사용자 등록을 성공하였습니다!","새로운 사용자 추가!", JOptionPane.ERROR_MESSAGE);
                    UserName.setText("");
                    ...
                    Year.setText("");
                       ...
                       JOptionPane.showMessageDialog(UserForm.this, "새 사용자를 추가할 수 없습니다","사용자 추가 에러!", JOptionPane.ERROR_MESSAGE);
